...
fun CacheSettings() {
    ...
    Column(
        ...
        SettingsDescription(text = stringResource(id = R.string.cache_runs_out))
        ...
        Coil.imageLoader(context).diskCache?.let { diskCache ->
            ...
            SettingsEntryGroupText(title = stringResource(id = R.string.image_cache))
        ...
        binder?.cache?.let { cache ->
            ...
            SettingsEntryGroupText(title = stringResource(id = R.string.song_cache))
